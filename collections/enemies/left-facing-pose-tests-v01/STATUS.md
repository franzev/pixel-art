...
1. **Crooked Bellman**
   ...
   - Native v02 draft:
     `archive/legacy-art/enemies/left-facing-pose-tests-v01/drafts/01-crooked-bellman-left-facing-v02-native-96x96.png`
   - Preview:
     `art-catalog/review-sheets/enemies/left-facing-pose-tests-v01/drafts/01-crooked-bellman-left-facing-v02-preview-6x.png`
...
2. **Roadside White Lady**
   ...
   - Medium-density v03 reference:
     `public/art/enemies/left-facing-pose-tests-v01/drafts/02-roadside-white-lady-left-facing-medium-density-v03-reference-256.png`
...
- `art-catalog/review-sheets/enemies/left-facing-pose-tests-v01/left-facing-pose-tests-v01-draft-review-sheet.png` — three references in one
