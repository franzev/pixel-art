# Infernal Demons Batch 13 — Status

**Status:** Complete draft batch; awaiting user review
**Prepared and generated:** 2026-07-28
**Valid draft assets:** 15 of 15
**Rejected image passes:** 4
**Blocked calls without output:** 1
**Retained assets:** 0
**Lore/count changes:** None

This batch responds to the user's Batch 11 feedback by excluding imps,
canine enemies, bell demons, beetles/insects, and bulky brutes. The roster uses
adult-proportioned lean fighters, goat- and ram-headed demons, robed occult
casters, winged hunters, and gaunt elites.

All unapproved files remain under `drafts/`. No retained manifest was created,
no files were promoted, and no canonical lore or retained counts were changed.

## Valid drafts

The height column is the measured visible foreground bounding height in each
256 × 256 nearest-neighbor reference.
...
Rejected images were not copied into the batch folder.

1. Pyre Chain Harvester pass 1 — four lit links instead of five.
2. Pyre Chain Harvester pass 2 — six lit links instead of five.
3. Pyre Chain Harvester pass 3 — correct link staging but a portrait canvas
   instead of the required square source.
4. Infernal Procession Lord pass 1 — too muscular and included a ground shadow,
   returning toward the rejected brute direction.
5. Flesh-Veil Oracle call 1 — blocked before image creation when the generator
   misread the skin description; the successful call used full ritual clothing
   and explicitly nonsexual framing.

## Review files

- `drafts/infernal-demons-batch-13-draft-review-sheet-01-05.png`
- `drafts/infernal-demons-batch-13-draft-review-sheet-06-10.png`
- `drafts/infernal-demons-batch-13-draft-review-sheet-11-15.png`
- `drafts/infernal-demons-batch-13-draft-review-sheet.png` — 5 × 3 master
- `drafts/infernal-demons-batch-13-gameplay-scale-test-640x360.png`

## Batch review

- Excluded archetypes: pass; no imps, dogs, bell carriers, insects, or brutes.
- Anatomy and equipment: pass for the fifteen accepted drafts.
- Silhouette variety: pass; duelists, polearm users, casters, winged hunters,
  chain control, and gaunt elites remain distinct.
- Palette: pass; scarlet, flesh-pink, dirty bone, soot-black, and ember-orange
  remain coherent without making every design uniformly red.
- Pixel treatment and 256 readability: pass.
- Cropping: pass; required anatomy, weapons, wings, tails, and effects remain
  inside the accepted square sources.
- Background: pass; warm near-black with no green backgrounds.
- Horror content: pass; intact stylized flesh and no graphic gore.

## Promotion gate

Retained count remains zero. Do not create a retained manifest, update canonical
lore or counts, or move files out of `drafts/` until the user explicitly
approves individual designs.
